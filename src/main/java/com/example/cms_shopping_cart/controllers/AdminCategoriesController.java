...
public class AdminCategoriesController 
{
    ...
    @PostMapping("/add")
    public String add(@Valid Category category, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes)
    {
        ...
        Category categoryExists = categoryRepo.findBySlug(slug);
    ...
    {
        Category categoryCurrent = categoryRepo.findById(category.getId());
        if (bindingResult.hasErrors()) 
        {
