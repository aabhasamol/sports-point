...
public class AdminPagesController {
    ...
    @PostMapping("/add")
    public String add(@Valid page page, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes)
    {
    ...
    {
        page pageCurrent = pageRepo.findById(page.getId());
        if (bindingResult.hasErrors()) 
        {
